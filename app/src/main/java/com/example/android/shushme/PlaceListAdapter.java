...
public class PlaceListAdapter extends RecyclerView.Adapter<PlaceListAdapter.PlaceViewHolder> {
    ...
    public PlaceListAdapter(Context context, PlaceBuffer buffer) {
        //  (4) Take a PlaceBuffer as an input and store it as a local private member mPlaces
    ...
    public void onBindViewHolder(PlaceViewHolder holder, int position) {
        //  (6) Implement onBindViewHolder to set the view holder's Name and Address text fields
    ...
    public int getItemCount() {
        //  (5) Update getItemCount to return mPlaces's item count
        if(mPlaces == null)
            return 0;
        return mPlaces.getCount();
    }

    // (7) Implement a public method swapPlaces that replaces the current mPlaces PlaceBuffer with a new one
